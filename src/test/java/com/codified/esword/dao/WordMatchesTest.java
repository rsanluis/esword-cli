...
public class WordMatchesTest {
  ...
  private void populateTable(String tableName, List<Bible> bibleList) {
    ...
    for (int i = 0; i < bibleList.size(); i++) {
      ...
      verse = Strings.CS.replace(verse, "<num>", " ");
      verse = Strings.CS.replace(verse, "</num>", " ");
      verse = Strings.CS.replace(verse, "<sup>", " ");
      verse = Strings.CS.replace(verse, "</sup>", " ");
      verse = Strings.CS.replace(verse, "<i>", " ");
      verse = Strings.CS.replace(verse, "</i>", " ");
      verse = Strings.CS.replace(verse, "<b>", " ");
      verse = Strings.CS.replace(verse, "</b>", " ");
      verse = Strings.CS.replace(verse, "<red>", " ");
      verse = Strings.CS.replace(verse, "</red>", " ");
      verse = Strings.CS.replace(verse, "<blu>", " ");
      verse = Strings.CS.replace(verse, "</blu>", " ");
      verse = Strings.CS.replace(verse, "(", " ");
      verse = Strings.CS.replace(verse, ")", " ");
      verse = Strings.CS.replace(verse, ":", " ");
      verse = Strings.CS.replace(verse, ";", " ");
      verse = Strings.CS.replace(verse, ".", " ");
